...
// Timing
export const TIMING_SYNC_INTERVAL_MS = 2000;
export const TIMING_SAMPLE_WINDOW = 10;
export const TIMING_TIE_THRESHOLD_MS = 5;
export const TIMING_OUTLIER_SIGMA = 2;

// Reveal
export const MIN_REVEAL_DURATION = 5;
